...
public class OmniOpProFinalCutSquid extends OpMode {
    ...
    public void loop() {
        ...
        robot.LiftClawControl(liftclawposition, gamepad1.a, gamepad1.y);
